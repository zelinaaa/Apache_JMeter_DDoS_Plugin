...
/**
 * This Test Element class stores properties of FIN flood DoS attack and starts trafgen generator using instance of TrafgenControl class
 *
 * @author Gity a.s.
 */

public class FinFloodSampler extends AbstractSampler implements TestStateListener, Trafgen{
	public static final String DMAC = "FinFloodSampler.dmac";
    public static final String SMACSINGLE = "FinFloodSampler.smacSingle";
    public static final String SMACMIN = "FinFloodSampler.smacmin";
    public static final String SMACMAX = "FinFloodSampler.smacmax";
    public static final String RANDOMMAC = "FinFloodSampler.randomsmac";
    public static final String SMACTG = "FinFloodSampler.smacTG";

    public static final String TARGETIP = "FinFloodSampler.targetIP";
    public static final String SOURCEIPSINGLE = "FinFloodSampler.sourceIPSingle";
    public static final String RANDOMIP = "FinFloodSampler.randIP";
    public static final String SOURCEIPMIN = "FinFloodSampler.sourceIPmin";
    public static final String SOURCEIPMAX = "FinFloodSampler.sourceIPmax";
    public static final String SOURCEIPTG = "FinFloodSampler.sourceIPTG";

    public static final String IPV6ENABLED = "FinFloodSampler.ipv6enabled";
    public static final String TARGETIPV6 = "FinFloodSampler.targetIPv6";
    public static final String SOURCEIPV6 = "FinFloodSampler.sourceIPv6";
    public static final String RANDOMIPV6 = "FinFloodSampler.randomIPv6";
    public static final String SOURCEIPV6MIN = "FinFloodSampler.sourceIPv6Min";
    public static final String SOURCEIPV6MAX = "FinFloodSampler.sourceIPv6Max";
    public static final String NUMBEROFIPV6ADDRESSES = "FinFloodSampler.numberOfIPv6Addresses";

    public static final String TTL = "FinFloodSampler.ttl";

    public static final String SOURCEPORTSINGLE = "FinFloodSampler.sourcePortSingle";
    public static final String RANDOMPORT = "FinFloodSampler.randPort";
    public static final String SOURCEPORTMIN = "FinFloodSampler.sourcePortmin";
    public static final String SOURCEPORTMAX = "FinFloodSampler.sourcePortmax";
    public static final String DPORT = "FinFloodSampler.dPort";
    public static final String SOURCEPORTTG = "FinFloodSampler.sourcePortTG";

    public static final String WINSIZE = "FinFloodSampler.winSize";
    public static final String NUMBER = "FinFloodSampler.number";
    public static final String RATE = "FinFloodSampler.rate";
    public static final String INTERF = "FinFloodSampler.interface";
    public static final String PAYLOAD = "FinFloodSampler.payload";
    ...
    public static final String DYNAMICRATE = "FinFloodSampler.dynamicRate";
    public static final String configFileSuffix = "FinFlood.cfg";
    public static final String configFileSuffixIpv6 = "FinFloodIpv6.cfg";
    private static final long serialVersionUID = 240L;
    private static final Logger log = LoggerFactory.getLogger(FinFloodSampler.class);
    ...
    public Object clone() {
        try {
            ...
            ((FinFloodSampler) clonedElement).trafgenControl = this.trafgenControl;
