package eu.gity.jmeter.ddos.finflood;
...
/**
 * This GUI class provides user interface to setup FIN flood DoS attack
 *
 * @author Gity a.s.
 */

public class FinFloodGui extends AbstractSamplerGui{
	@Serial
    ...
    public String getLabelResource() {
        return DDOS_FIN_FLOOD_TITLE; // $NON-NLS-1$
    }
    ...
    public String getStaticLabel() {
        return JMeterUtils.getLocaleString(DDOS_FIN_FLOOD_TITLE);
    }
    ...
    public TestElement createTestElement() {
        FinFloodSampler sampler = new FinFloodSampler();
    ...
    public void modifyTestElement(TestElement te) {
        ...
        if (selectedDev != null) { //Maybe no network devices were found       
            te.setProperty(FinFloodSampler.INTERF, selectedDev.toString());
        }

        te.setProperty(FinFloodSampler.DMAC, dMAC.getText());
        te.setProperty(FinFloodSampler.SMACSINGLE, sMACsingle.getText());
        te.setProperty(FinFloodSampler.SMACMIN, sMACmin.getText());
        te.setProperty(FinFloodSampler.SMACMAX, sMACmax.getText());
        te.setProperty(FinFloodSampler.RANDOMMAC, incrementalMAC.isSelected());
        te.setProperty(FinFloodSampler.TARGETIP, targetIP.getText());
        te.setProperty(FinFloodSampler.TARGETIPV6, targetIPv6.getText());
        te.setProperty(FinFloodSampler.SOURCEIPSINGLE, sourceIPsingle.getText());
        te.setProperty(FinFloodSampler.SOURCEIPV6, sourceIPv6.getText());
        te.setProperty(FinFloodSampler.RANDOMIP, randomIP.isSelected());
        te.setProperty(FinFloodSampler.RANDOMIPV6, randomIPv6.isSelected());
        te.setProperty(FinFloodSampler.IPV6ENABLED, ipv6Enabled.isSelected());
        te.setProperty(FinFloodSampler.NUMBEROFIPV6ADDRESSES, numberOfIPv6Addresses.getText());
        te.setProperty(FinFloodSampler.SOURCEIPMIN, sourceIPMIN.getText());
        te.setProperty(FinFloodSampler.SOURCEIPMAX, sourceIPMAX.getText());
        te.setProperty(FinFloodSampler.SOURCEIPV6MIN, sourceIPv6Min.getText());
        te.setProperty(FinFloodSampler.SOURCEIPV6MAX, sourceIPv6Max.getText());
        te.setProperty(FinFloodSampler.TTL, ttl.getText());
        te.setProperty(FinFloodSampler.SOURCEPORTSINGLE, sourcePortSingle.getText());
        te.setProperty(FinFloodSampler.RANDOMPORT, randomPort.isSelected());
        te.setProperty(FinFloodSampler.SOURCEPORTMIN, sourcePortMIN.getText());
        te.setProperty(FinFloodSampler.SOURCEPORTMAX, sourcePortMAX.getText());
        te.setProperty(FinFloodSampler.DPORT, destPort.getText());
        te.setProperty(FinFloodSampler.WINSIZE, windowSize.getText());
        te.setProperty(FinFloodSampler.PAYLOAD, payLoad.getText());
        te.setProperty(FinFloodSampler.NUMBER, number.getText());
        te.setProperty(FinFloodSampler.RATE, rate.getText());

        //Following blocks assigns final values for trafgen config to separate properties 
        if (incrementalMAC.isSelected()) {
            te.setProperty(FinFloodSampler.SMACTG, DDoSUtils.getInstance().macIncremental(sMACmin.getText(), sMACmax.getText()));
        } else {
            te.setProperty(FinFloodSampler.SMACTG, sMACsingle.getText());
        }
        if (randomIP.isSelected()) {
            te.setProperty(FinFloodSampler.SOURCEIPTG, DDoSUtils.getInstance().ipRandom(sourceIPMIN.getText(), sourceIPMAX.getText()));
        } else {
            te.setProperty(FinFloodSampler.SOURCEIPTG, sourceIPsingle.getText());
        }
        if (randomPort.isSelected()) {
            te.setProperty(FinFloodSampler.SOURCEPORTTG, "drnd(" + sourcePortMIN.getText() + "," + sourcePortMAX.getText() + ")");
        } else {
            te.setProperty(FinFloodSampler.SOURCEPORTTG, sourcePortSingle.getText());
        }
        ((FinFloodSampler) te).checkInit();
    }
    ...
    public void configure(TestElement element) {
        ...
        selectInt.setSelectedItem(element.getPropertyAsString(FinFloodSampler.INTERF));

        dMAC.setText(element.getPropertyAsString(FinFloodSampler.DMAC));
        sMACsingle.setText(element.getPropertyAsString(FinFloodSampler.SMACSINGLE));
        incrementalMAC.setSelected(element.getPropertyAsBoolean(FinFloodSampler.RANDOMMAC, false));
        sMACmin.setText(element.getPropertyAsString(FinFloodSampler.SMACMIN));
        sMACmax.setText(element.getPropertyAsString(FinFloodSampler.SMACMAX));
        targetIP.setText(element.getPropertyAsString(FinFloodSampler.TARGETIP));
        targetIPv6.setText(element.getPropertyAsString(FinFloodSampler.TARGETIPV6));
        sourceIPsingle.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPSINGLE));
        sourceIPv6.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPV6));
        randomIP.setSelected(element.getPropertyAsBoolean(FinFloodSampler.RANDOMIP, false));
        randomIPv6.setSelected(element.getPropertyAsBoolean(FinFloodSampler.RANDOMIPV6));
        ipv6Enabled.setSelected(element.getPropertyAsBoolean(FinFloodSampler.IPV6ENABLED));
        numberOfIPv6Addresses.setText(element.getPropertyAsString(FinFloodSampler.NUMBEROFIPV6ADDRESSES));
        sourceIPMIN.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPMIN));
        sourceIPMAX.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPMAX));
        sourceIPv6Min.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPV6MIN));
        sourceIPv6Max.setText(element.getPropertyAsString(FinFloodSampler.SOURCEIPV6MAX));

        ttl.setText(element.getPropertyAsString(FinFloodSampler.TTL));
        destPort.setText(element.getPropertyAsString(FinFloodSampler.DPORT));
        sourcePortSingle.setText(element.getPropertyAsString(FinFloodSampler.SOURCEPORTSINGLE));
        randomPort.setSelected(element.getPropertyAsBoolean(FinFloodSampler.RANDOMPORT, false));
        sourcePortMIN.setText(element.getPropertyAsString(FinFloodSampler.SOURCEPORTMIN));
        sourcePortMAX.setText(element.getPropertyAsString(FinFloodSampler.SOURCEPORTMAX));
        windowSize.setText(element.getPropertyAsString(FinFloodSampler.WINSIZE));
        payLoad.setText(element.getPropertyAsString(FinFloodSampler.PAYLOAD));

        ((FinFloodSampler) element).checkInit();
        if (((FinFloodSampler) element).isDynamicRate()) {
            dynamicRate = true;
            element.setProperty(FinFloodSampler.DYNAMICRATE, true); //Must be here to prevent DYNAMICRATE property from being deleted by JMeter
            number.setEnabled(false);
            rate.setEnabled(false);
        } else {
            dynamicRate = false;
            element.setProperty(FinFloodSampler.DYNAMICRATE, false); //Must be here to prevent DYNAMICRATE property from being deleted by JMeter
            number.setText(element.getPropertyAsString(FinFloodSampler.NUMBER));
            rate.setText(element.getPropertyAsString(FinFloodSampler.RATE));
